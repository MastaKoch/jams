...
const resourceSeed = [
  {
    ...
    comments:[{body: "This is an incredible resource for early development. I never realized before watching this video the importance or reading with my children versus reading to them.", username:"shannbann7"}]
  ...
  },
  {
    ...
    comments: [{body: "With writing fastly being replaced by keyboards, it is refreshing to learn how integral the skill is to young children's critical thinking development.", username: "swann"}]
  ...
  },
  {
    ...
    comments: [{body: "As technology continues to evolve, it is comforting to know that there are resources available that allows me to safely explore with my children.", username: "mia"}]
  ...
  },
  {
    ...
    comments: [{body: "Awesome reminder that art forms differ in many ways and that children can benefit greatly from exploring them all.", username: "Alex1"}]
  ...
  },
  {
    ...
    comments: [{body: "Love this! Great resource for stimulating little thinkers.", username: "winndixie"}]
  ...
  },
  {
    ...
    comments: [{body: "Simple, and easy to incorporate into everyday activities for practice.", username: "harryPotter"}]
  ...
  },
  {
    ...
    comments: [{body: "I'm excited that this resource is a series and talks about the various types and aspects of engineering. Such a diverse field.", username: "pacMan"}]
